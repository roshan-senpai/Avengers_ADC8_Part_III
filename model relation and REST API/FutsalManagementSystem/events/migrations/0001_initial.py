# Generated by Django 3.0.1 on 2020-01-24 09:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_field', models.ManyToManyField(to='events.Customer')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=100, verbose_name='Address')),
                ('staff_field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Field')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='customer_payment',
            field=models.ManyToManyField(to='events.Payment'),
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('team_name', models.CharField(max_length=100, verbose_name='Event Name')),
                ('customer_booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Customer')),
            ],
        ),
    ]
